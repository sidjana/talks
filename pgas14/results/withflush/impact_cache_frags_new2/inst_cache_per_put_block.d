...
TITLE_CACHE = "set title 'Block:Cache hits/PUT' \
font 'Times-Roman, 4' offset -3,-1"
...
plot "2901_opti_impact_cache_".FIRST."_".LAST.".out" using X:9 @USING_M title FIRST ls 1

@TITLE_CACHE
@RMARGIN
@TMARGIN
set key vertical left center
plot "2901_opti_impact_cache_".FIRST."_".LAST.".out" using X:14 @USING_M title LAST ls 1
...
@BMARGIN
set key vertical right bot
plot "2901_opti_impact_cache_".FIRST."_".LAST.".out" using X:12 @USING_M title FIRST."->".LAST ls 1
