...
FILE_NAME_OPENIB_2MB = "openib_2MB.dat.bak1"
...
TITLE_COREPOW_TCP_72B = "set title 'TCP_RNDV: Execution Time (secs)' font \
'Times-Roman, 4' offset -3,0"
TITLE_COREPOW_OPENIB_72B = "set title 'OPENIB_RNDV: Execution Time (secs)' font \
'Times-Roman, 4' offset -3,0"
TITLE_COREPOW_TCP_2MB = "set title 'TCP_EAGER: Execution Time (secs)' font \
'Times-Roman, 4' offset -3,0"
TITLE_COREPOW_OPENIB_2MB = "set title 'OPENIB_EAGER: Execution Time (secs)' font \
'Times-Roman, 4' offset -3,0"

@TITLE_COREPOW_TCP_72B; @CBLABEL_POW
@TMARGIN; @LMARGIN
@XTICS; @YTICS
Z=4;set log cb  1.0000002; set cbrange[0.0000001:3.7] ;
