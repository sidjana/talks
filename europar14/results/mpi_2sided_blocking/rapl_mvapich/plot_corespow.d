...
TITLE_COREPOW_TCP_72B = "set title 'TCP_RVDV: Cores Power (W)' font \
'Times-Roman, 4' offset -3,0"
TITLE_COREPOW_OPENIB_72B = "set title 'OPENIB_RNDV:Cores Power (Watts)' font \
'Times-Roman, 4' offset -3,0"
TITLE_COREPOW_TCP_2MB = "set title 'TCP_EAGER Cores Power (Watts)' font \
'Times-Roman, 4' offset -3,0"
TITLE_COREPOW_OPENIB_2MB = "set title 'OPENIB_EAGER Cores Power (Watts)' font \
'Times-Roman, 4' offset -3,0"

@TITLE_COREPOW_TCP_72B; @CBLABEL_POW
@TMARGIN; @LMARGIN
@XTICS; @YTICS
Z=5;set log cb  1.0008282; set cbrange[16.4:16.8] ;
splot FILE_NAME_TCP_72B @USING_M

@TITLE_COREPOW_OPENIB_72B; @CBLABEL_POW
@TMARGIN; @RMARGIN
@XTICS; @NOYTICS
Z=5;set log cb  1.0008282; set cbrange[16.35:16.49] ;
splot FILE_NAME_OPENIB_72B @USING_M

#@TITLE_COREPOW_TCP_2MB; @CBLABEL_POW
#@BMARGIN; @LMARGIN
#@XTICS; @YTICS
#Z=5;set log cb  1.0008282; set cbrange[15.7:17] ;
#splot FILE_NAME_TCP_2MB @USING_M

@TITLE_COREPOW_OPENIB_2MB; @CBLABEL_POW
@BMARGIN; @RMARGIN
@XTICS; @NOYTICS
Z=5;set log cb  1.0008282; set cbrange[16.5:17.38] ;
