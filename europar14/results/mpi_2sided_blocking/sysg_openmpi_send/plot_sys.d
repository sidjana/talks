...
set terminal pdf
set output "sys_power.pdf"
#set terminal pngcairo
#set output "sys_power.png"
...
TITLE_SYSPOW_TCP_72B = "set title 'TCP_RVDV: SYS Power (W)' font \
'Times-Roman, 4' offset -3,0"
TITLE_SYSPOW_OPENIB_72B = "set title 'OPENIB_RNDV: SYS Power (Watts)' font \
'Times-Roman, 4' offset -3,0"
TITLE_SYSPOW_TCP_2MB = "set title 'TCP_EAGER: SYS Power (Watts)' font \
'Times-Roman, 4' offset -3,0"
TITLE_SYSPOW_OPENIB_2MB = "set title 'OPENIB_EAGER: SYS Power (Watts)' font \
'Times-Roman, 4' offset -3,0"

@TITLE_SYSPOW_TCP_72B; @CBLABEL_POW
@TMARGIN; @LMARGIN
@XTICS; @YTICS
Z=4 ; set log cb 1.0001; set cbrange[234:278] ;
splot FILE_NAME_TCP_72B @USING_M

@TITLE_SYSPOW_OPENIB_72B; @CBLABEL_POW
@TMARGIN; @RMARGIN
@XTICS; @NOYTICS
Z=4 ; set log cb 1.0001; set cbrange[234:278] ;
splot FILE_NAME_OPENIB_72B @USING_M

@TITLE_SYSPOW_TCP_2MB; @CBLABEL_POW
@BMARGIN; @LMARGIN
@XTICS; @YTICS
Z=4 ; set log cb 1.0001; set cbrange[234:278] ;
splot FILE_NAME_TCP_2MB @USING_M

@TITLE_SYSPOW_OPENIB_2MB; @CBLABEL_POW
@BMARGIN; @RMARGIN
@XTICS; @NOYTICS
Z=4 ; set log cb 1.0001; set cbrange[234:278] ;
