...
set terminal pdf
set output "ipmi_power.pdf"
#set terminal pngcairo
#set output "ipmi_power.png"
...
TITLE_IPMIPOW_TCP_72B = "set title 'TCP_RVDV: IPMI Power (W)' font \
'Times-Roman, 4' offset -3,0"
TITLE_IPMIPOW_OPENIB_72B = "set title 'OPENIB_RNDV: IPMI Power (Watts)' font \
'Times-Roman, 4' offset -3,0"
TITLE_IPMIPOW_TCP_2MB = "set title 'TCP_EAGER: IPMI Power (Watts)' font \
'Times-Roman, 4' offset -3,0"
TITLE_IPMIPOW_OPENIB_2MB = "set title 'OPENIB_EAGER: IPMI Power (Watts)' font \
'Times-Roman, 4' offset -3,0"

@TITLE_IPMIPOW_TCP_72B; @CBLABEL_POW
@TMARGIN; @LMARGIN
@XTICS; @YTICS
Z=3 ; set log cb 1.01; set cbrange[199:218] ;
splot FILE_NAME_TCP_72B @USING_M

@TITLE_IPMIPOW_OPENIB_72B; @CBLABEL_POW
@TMARGIN; @RMARGIN
@XTICS; @NOYTICS
Z=3 ; set log cb 1.01; set cbrange[199:218] ;
splot FILE_NAME_OPENIB_72B @USING_M

@TITLE_IPMIPOW_TCP_2MB; @CBLABEL_POW
@BMARGIN; @LMARGIN
@XTICS; @YTICS
Z=3 ; set log cb 1.01; set cbrange[199:218] ;
splot FILE_NAME_TCP_2MB @USING_M

@TITLE_IPMIPOW_OPENIB_2MB; @CBLABEL_POW
@BMARGIN; @RMARGIN
@XTICS; @NOYTICS
Z=3 ; set log cb 1.01; set cbrange[199:218] ;
