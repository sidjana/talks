FILE_NAME_OPENIB_72B = "openib72b.dat.2"
FILE_NAME_OPENIB_2MB = "openib2mb.dat.2"
FILE_NAME_TCP_72B = "tcp72b.dat.3"
FILE_NAME_TCP_2MB = "tcp2mb.dat.4"
...
@TMARGIN; @LMARGIN
@XTICS; @YTICS
Z=5;set log cb 1.01; set cbrange[75:88] ;
...
unset label
unset arrow
set label 1 "(A)" at 8,16 center font "Times-Roman,4"
set arrow from 16,16 to 128,8 nohead front lw 0.5 
set label 2 "(B)" at 32,1024 center font "Times-Roman,4"
set arrow from 64,1024 to 1024,8 nohead front lw 0.5
